...
CREATE TABLE `t_zyhd`  (
  ...
  `FB_ZT` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '发布状态：未发布；已发布；已下架',
...
INSERT INTO `t_zyhd` VALUES (27, '创新创业文化节志愿服务', '2026-02-12 15:00:00', '2026-02-14 15:00:00', '2026-02-15 15:00:00', '2026-02-16 18:00:00', '摊位布置与秩序维护、游客引导与活动讲解、后勤保障工作', '浙江外国语学院（校内，具体地点另行通知）', 20, 0, 0, '校园建设', NULL, NULL, '热情开朗，有服务意识至责任心强，能按时到岗至对宋韵文化或创新创业活动感兴趣者优先。', '无', '国商学院', '未开始', '已发布');
